...
public class TGTrackSpacingTest extends TestCase {

	/**
	Test method for 'org.herac.tuxguitar.graphics.control.TGTrackSpacing.TGTrackSpacing(TGLayout)'
	@CoViewTest (coview_methodundertest=org.herac.tuxguitar.graphics.control.TGTrackSpacing#TGTrackSpacing(TGLayout))*/
	public void testTGTrackSpacingTGLayout() {
		// Method under test arguments
		TGLayout layout = null;

		// Constructor under test arguments// Constructor under test
		TGTrackSpacing constructorInstance = new TGTrackSpacing(layout);
