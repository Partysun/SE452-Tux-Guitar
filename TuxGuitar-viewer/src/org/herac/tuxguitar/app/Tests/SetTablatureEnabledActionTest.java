...
public class SetTablatureEnabledActionTest extends TestCase {

	/**
	Test method for 'org.herac.tuxguitar.app.actions.layout.SetTablatureEnabledAction.execute(AWTEvent)'
	...
	/**
	Test method for 'org.herac.tuxguitar.app.actions.layout.SetTablatureEnabledAction.SetTablatureEnabledAction()'
	@CoViewTest (coview_methodundertest=org.herac.tuxguitar.app.actions.layout.SetTablatureEnabledAction#SetTablatureEnabledAction())*/
	public void testSetTablatureEnabledAction() {

		// Constructor under test
		SetTablatureEnabledAction constructorInstance = new SetTablatureEnabledAction();
