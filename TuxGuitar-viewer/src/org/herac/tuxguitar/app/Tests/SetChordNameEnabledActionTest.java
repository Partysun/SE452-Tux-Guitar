...
public class SetChordNameEnabledActionTest extends TestCase {

	/**
	Test method for 'org.herac.tuxguitar.app.actions.layout.SetChordNameEnabledAction.execute(AWTEvent)'
	...
	/**
	Test method for 'org.herac.tuxguitar.app.actions.layout.SetChordNameEnabledAction.SetChordNameEnabledAction()'
	@CoViewTest (coview_methodundertest=org.herac.tuxguitar.app.actions.layout.SetChordNameEnabledAction#SetChordNameEnabledAction())*/
	public void testSetChordNameEnabledAction() {

		// Constructor under test
		SetChordNameEnabledAction constructorInstance = new SetChordNameEnabledAction();
