...
public class GoPreviousMeasureActionTest extends TestCase {

	/**
	Test method for 'org.herac.tuxguitar.app.actions.measure.GoPreviousMeasureAction.execute(AWTEvent)'
	...
	/**
	Test method for 'org.herac.tuxguitar.app.actions.measure.GoPreviousMeasureAction.GoPreviousMeasureAction()'
	@CoViewTest (coview_methodundertest=org.herac.tuxguitar.app.actions.measure.GoPreviousMeasureAction#GoPreviousMeasureAction())*/
	public void testGoPreviousMeasureAction() {

		// Constructor under test
		GoPreviousMeasureAction constructorInstance = new GoPreviousMeasureAction();
