...
public class SetScoreEnabledActionTest extends TestCase {

	/**
	Test method for 'org.herac.tuxguitar.app.actions.layout.SetScoreEnabledAction.execute(AWTEvent)'
	...
	/**
	Test method for 'org.herac.tuxguitar.app.actions.layout.SetScoreEnabledAction.SetScoreEnabledAction()'
	@CoViewTest (coview_methodundertest=org.herac.tuxguitar.app.actions.layout.SetScoreEnabledAction#SetScoreEnabledAction())*/
	public void testSetScoreEnabledAction() {

		// Constructor under test
		SetScoreEnabledAction constructorInstance = new SetScoreEnabledAction();
