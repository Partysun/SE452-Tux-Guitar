...
public class SelectTrackActionTest extends TestCase {

	/**
	Test method for 'org.herac.tuxguitar.app.actions.track.SelectTrackAction.execute(AWTEvent)'
	...
	/**
	Test method for 'org.herac.tuxguitar.app.actions.track.SelectTrackAction.SelectTrackAction()'
	@CoViewTest (coview_methodundertest=org.herac.tuxguitar.app.actions.track.SelectTrackAction#SelectTrackAction())*/
	public void testSelectTrackAction() {

		// Constructor under test
		SelectTrackAction constructorInstance = new SelectTrackAction();
