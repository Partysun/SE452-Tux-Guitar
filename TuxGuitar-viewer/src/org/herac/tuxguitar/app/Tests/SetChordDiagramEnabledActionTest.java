...
public class SetChordDiagramEnabledActionTest extends TestCase {

	/**
	Test method for 'org.herac.tuxguitar.app.actions.layout.SetChordDiagramEnabledAction.execute(AWTEvent)'
	...
	/**
	Test method for 'org.herac.tuxguitar.app.actions.layout.SetChordDiagramEnabledAction.SetChordDiagramEnabledAction()'
	@CoViewTest (coview_methodundertest=org.herac.tuxguitar.app.actions.layout.SetChordDiagramEnabledAction#SetChordDiagramEnabledAction())*/
	public void testSetChordDiagramEnabledAction() {

		// Constructor under test
		SetChordDiagramEnabledAction constructorInstance = new SetChordDiagramEnabledAction();
